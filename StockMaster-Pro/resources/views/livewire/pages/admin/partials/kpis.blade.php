<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300">
    <div class="p-5">
      <div class="flex items-center justify-between">
        <p class="text-xs font-bold uppercase tracking-widest text-gray-400">Total Products</p>
      ...
      <div class="mt-3 flex items-end justify-between">
        <div>
          <h3 class="text-2xl font-bold text-gray-900 leading-none">{{ $totoalProducts }}</h3>
          <p class="mt-2 text-sm text-gray-500">Items in stock</p>
        </div>
        <span class="flex items-center gap-x-1 py-1 px-2 rounded-lg bg-green-50 text-green-600 font-medium text-xs">
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300">
    <div class="p-5">
      <div class="flex items-center justify-between">
        <p class="text-xs font-bold uppercase tracking-widest text-gray-400">Categories</p>
      ...
      <div class="mt-3">
        <h3 class="text-2xl font-bold text-gray-900 leading-none">{{ $totalCategories }}</h3>
        <p class="mt-2 text-sm text-gray-500">Live segments</p>
      </div>
    </div>
  </div>
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300">
    <div class="p-5">
      <div class="flex items-center justify-between">
        <p class="text-xs font-bold uppercase tracking-widest text-gray-400">Out of Stock</p>
      ...
      <div class="mt-3 flex items-end justify-between">
        <div>
          <h3 class="text-2xl font-bold text-gray-900 leading-none">{{ $totalLowstock }}</h3>
          <p class="mt-2 text-sm text-gray-500">Needs attention</p>
        </div>
        <span class="py-1 px-2 rounded-lg bg-red-100 text-red-700 font-bold text-[10px] uppercase">
          Critical
        </span>
      </div>
    </div>
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300">
    <div class="p-5">
      <div class="flex items-center justify-between">
        <p class="text-xs font-bold uppercase tracking-widest text-gray-400">Total Revenue</p>
      ...
      <div class="mt-3">
        <h3 class="text-2xl font-bold text-gray-900 leading-none">{{'$ ' . $getRevenue }}</h3>
