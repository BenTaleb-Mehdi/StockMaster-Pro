        ...
        <form wire:submit="deleteUser" class="p-8">
            ...
            <div class="mt-6">
                <input wire:model="password" type="password" 
                    class="py-2.5 px-4 block w-3/4 border-gray-200 rounded-xl text-sm focus:border-red-500 focus:ring-red-500/10 shadow-sm" 
            ...
            <div class="mt-8 flex justify-end gap-3">
                <button type="button" x-on:click="$dispatch('close')" 
                    class="py-2.5 px-5 text-sm font-semibold rounded-xl border border-gray-200 bg-white text-gray-600 hover:bg-gray-50 transition-all">
                    {{ __('Cancel') }}
                </button>
