<section>
    <form wire:submit="updateProfileInformation" class="space-y-6">
        <div>
            <label class="block text-sm font-bold text-gray-700 mb-1.5">{{ __('Name') }}</label>
            ...
            @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! auth()->user()->hasVerifiedEmail())
                <div class="mt-2 p-3 bg-amber-50 rounded-xl border border-amber-100">
                    <p class="text-sm text-amber-700">
                        ...
                        <button wire:click.prevent="sendVerification" class="underline font-bold hover:text-amber-900 transition-colors">
